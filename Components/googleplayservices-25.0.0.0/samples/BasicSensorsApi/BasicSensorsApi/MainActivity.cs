            ...
            mClient = new GoogleApiClientBuilder (this)
                ...
                .AddConnectionCallbacks(
                    ...
                    i => {
                        ...
                        if (i == GoogleApiClientConnectionCallbacks.CauseNetworkLost)
                            Log (TAG, "Connection lost.  Cause: Network Lost.");
                        else if (i == GoogleApiClientConnectionCallbacks.CauseServiceDisconnected)
