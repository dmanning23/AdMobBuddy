...
namespace PlusSample
{
    ...
    public class ListVisiblePeopleActivity : Activity, IGoogleApiClientConnectionCallbacks, IGoogleApiClientOnConnectionFailedListener, IDialogInterfaceOnCancelListener
    {
