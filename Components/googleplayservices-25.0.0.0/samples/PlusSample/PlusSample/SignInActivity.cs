...
using CheckResult = Android.Gms.Common.Apis.GoogleApiClientServerAuthCodeCallbacksCheckResult;

namespace PlusSample
{
    [Activity (Label = "Sign In")]			
    public class SignInActivity : Activity, IGoogleApiClientConnectionCallbacks, IGoogleApiClientOnConnectionFailedListener, IGoogleApiClientServerAuthCodeCallbacks
    {
